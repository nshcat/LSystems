...
import com.lsystems.android.rendering.TransformedMesh
import com.lsystems.android.rendering.VoxelFace
import com.lsystems.android.rendering.materials.SimpleMaterial
    ...
    init
    {
        for(ix in 0 until this.voxelWidth)
        {
            for(iz in 0 until this.voxelDepth)
            {
                ...
                // Snap to voxel grid
                //noiseVal -= noiseVal.rem(this.voxelSize.toDouble())
